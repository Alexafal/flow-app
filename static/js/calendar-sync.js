...
class CalendarSync {
    ...
    updateUI() {
        ...
        if (statusEl) {
            if (this.isConnected) {
                statusEl.className = 'calendar-sync-status connected';
                statusEl.innerHTML = '<span class="sync-indicator"></span><span>Google Calendar: Connected</span>';
                if (connectBtn) connectBtn.style.display = 'none';
                if (syncBtn) syncBtn.style.display = 'block';
                if (disconnectBtn) disconnectBtn.style.display = 'block';
            } else {
                statusEl.className = 'calendar-sync-status disconnected';
                statusEl.innerHTML = '<span class="sync-indicator"></span><span>Google Calendar: Not Connected</span>';
    ...
    async connectGoogleCalendar() {
        try {
            ...
            this.showInfo('Google Calendar OAuth is not yet configured. Using mock connection for testing.');
            
            // Mock connection
            this.isConnected = true;
            this.updateUI();
            this.startBackgroundSync();
            this.showSuccess('Connected to Google Calendar! (Mock mode)');
        } catch (error) {
